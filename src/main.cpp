...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    int64_t nSubsidy = 1 * COIN;
        if(pindexBest->nHeight <= 961)
        {
            nSubsidy = 5860 * COIN;
        
   } else if(pindexBest->nHeight > 961 and pindexBest->nHeight <= 1921) {
      
nSubsidy = 2350 * COIN;
}
else if(pindexBest->nHeight > 1921 and pindexBest->nHeight <= 2881) {
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Wtfcoin: check proof-of-stake block signature
...
// wtfcoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "wtfcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "WTF is more than a joke";
        CTransaction txNew;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xb4cb40376e6359d72ffc564a47cc64382ddbaa664f935160fa4f61c154083677"));
        block.print();
